...
<ul class="nav nav-tabs mb-4" role="tablist">
    <li class="nav-item"><a class="nav-link active" href="#tab-store" data-bs-toggle="tab">Store</a></li>
    <li class="nav-item"><a class="nav-link" href="#tab-contact" data-bs-toggle="tab">Contact</a></li>
    <li class="nav-item"><a class="nav-link" href="#tab-seo" data-bs-toggle="tab">SEO & Tracking</a></li>
    <li class="nav-item"><a class="nav-link" href="#tab-social" data-bs-toggle="tab">Social</a></li>
    <li class="nav-item"><a class="nav-link" href="#tab-payment" data-bs-toggle="tab">Payment</a></li>
    <li class="nav-item"><a class="nav-link" href="#tab-shipping" data-bs-toggle="tab">Shipping</a></li>
    <li class="nav-item"><a class="nav-link" href="#tab-display" data-bs-toggle="tab">Display</a></li>
    <li class="nav-item"><a class="nav-link" href="#tab-orders" data-bs-toggle="tab">Orders</a></li>
    <li class="nav-item"><a class="nav-link" href="#tab-consultation" data-bs-toggle="tab">Consultation</a></li>
</ul>
...
<div class="tab-content">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text"><iconify-icon icon="ri:facebook-fill" class="fs-16"></iconify-icon></span>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text"><iconify-icon icon="ri:instagram-line" class="fs-16"></iconify-icon></span>
                ...
                <div class="mb-0">
                    ...
                    <div class="input-group">
                        <span class="input-group-text"><iconify-icon icon="ri:twitter-x-line" class="fs-16"></iconify-icon></span>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-0" style="max-width:200px">
                    ...
                    <div class="form-text">Variants with stock ≤ this are flagged as low stock.</div>
    ...
    {{-- Consultation --}}
    <div class="tab-pane fade" id="tab-consultation">
        <div class="card mb-4">
            <div class="card-header">
                <h5 class="card-title mb-0 d-flex align-items-center gap-2">
